...
<head>
    ...
    background-size: contain; /* Menampilkan seluruh gambar tanpa terpotong */
    background-attachment: fixed; /* Agar tidak ikut scroll (opsional) */
}
...
<body class="bg-login flex items-center justify-end min-h-screen p-10">
    ...
    <div class="bg-white py-10 px-8 rounded-tr-[32px] rounded-bl-[32px] shadow-lg w-[400px] min-h-[700px] relative">
        <!-- Logo -->
        <div class="absolute -top-14 left-1/2 transform -translate-x-1/2 bg-[#E8EEF5] rounded-xl shadow-md p-5 w-32 text-center">
        ...
        <form id="loginForm" class="mt-10">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 flex items-center px-3 text-gray-500 border-r border-gray-300">
            ...
            <!-- Login Button -->
            <div class="mt-6">
                <button type="submit" class="w-full bg-[#C7D6EE] hover:bg-sky-700 text-black hover:text-[#ffffff] font-bold py-4 rounded-lg flex items-center justify-center gap-2 ">
